...
public class PostulacionOfertaController {
    ...
    public ResponseEntity<?> habilitarEmpresa(@RequestBody PostulacionCandidatoRequestDTO postulacionCandidatoRequestDTO) {
        PostulacionOferta postulacionOferta = postulacionOfertaService.postularComoCandidato(postulacionCandidatoRequestDTO);
